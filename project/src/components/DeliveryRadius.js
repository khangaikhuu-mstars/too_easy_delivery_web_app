      ...
      <div className="TabMap">
        <div className="container">
          <div className="DeliveryMap">
            <div className="deliveryMapBack"></div>
          </div>
        </div>
      </div>
      <div className="container">
        <div className="TextBus">
          <div className="DeliveryText">Хүргэлтийн бүс</div>
        </div>
      </div>
          ...
          <div className="TextWidth">
            <div>
              <div className="TextFlex">
                <div>
                  <div className="Abus">"A" бүс</div>
                </div>
                <div className="BusText">
                  <div className="BusList">
                    {' '}
                    <img src={Icon} className=" d-md-none" /> Нархан хотгон
                  </div>
                  <div className="BusList">
                    {' '}
                    <img src={Icon} className=" d-md-none" /> 26-байр
                  </div>
                  <div className="BusList">
                    {' '}
                    <img src={Icon} className=" d-md-none" /> Хоймор хотгон
                  </div>
            ...
            <div>
              <div className="TextFlex">
                ...
                <div className="BusText">
                  ...
                  <div className="BusList">
                    {' '}
                    <img src={Icon} className=" d-md-none" />
                    Хоймор хотгон
                  </div>
                  <div className="BusList2"> 56-байр</div>
                  <div className="BusList2"> 36-байр</div>
