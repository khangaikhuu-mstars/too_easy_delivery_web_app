                            ...
                            <div className="collapse1">
                                <div className="division">
                                    <div className="d-flex justify-content-between flex-row">
                                        ...
                                        <Nav.Link to='/home' className="tses">Хоолны цэс</Nav.Link>
                                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='d-flex justify-content-between flex-row'>
                                        ...
                                        <Nav.Link to='/delivery' className="tses">Хүргэлтийн бүс</Nav.Link>
                                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.953125 1.01758L0.367188 1.57422C0.25 1.7207 0.25 1.95508 0.367188 2.07227L5.66992 7.375L0.367188 12.707C0.25 12.8242 0.25 13.0586 0.367188 13.2051L0.953125 13.7617C1.09961 13.9082 1.30469 13.9082 1.45117 13.7617L7.60352 7.63867C7.7207 7.49219 7.7207 7.28711 7.60352 7.14062L1.45117 1.01758C1.30469 0.871094 1.09961 0.871094 0.953125 1.01758Z" fill="#F17228" />
                                        </svg>
                                ...
                                <div className="division">
                                    <div className="d-flex justify-content-between flex-row">
                                        ...
                                        <Nav.Link to='./' className="tses">Хэрэглэгчийн мэдээлэл</Nav.Link>
                                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.953125 1.01758L0.367188 1.57422C0.25 1.7207 0.25 1.95508 0.367188 2.07227L5.66992 7.375L0.367188 12.707C0.25 12.8242 0.25 13.0586 0.367188 13.2051L0.953125 13.7617C1.09961 13.9082 1.30469 13.9082 1.45117 13.7617L7.60352 7.63867C7.7207 7.49219 7.7207 7.28711 7.60352 7.14062L1.45117 1.01758C1.30469 0.871094 1.09961 0.871094 0.953125 1.01758Z" fill="#F17228" />
                                        </svg>
                                    ...
                                    <div className="d-flex justify-content-between flex-row">
                                        ...
                                        <Nav.Link to='./' className="tses">Миний захиалга</Nav.Link>
                                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.953125 1.01758L0.367188 1.57422C0.25 1.7207 0.25 1.95508 0.367188 2.07227L5.66992 7.375L0.367188 12.707C0.25 12.8242 0.25 13.0586 0.367188 13.2051L0.953125 13.7617C1.09961 13.9082 1.30469 13.9082 1.45117 13.7617L7.60352 7.63867C7.7207 7.49219 7.7207 7.28711 7.60352 7.14062L1.45117 1.01758C1.30469 0.871094 1.09961 0.871094 0.953125 1.01758Z" fill="#F17228" />
                                        </svg>
