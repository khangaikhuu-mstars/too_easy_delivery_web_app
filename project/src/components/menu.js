        ...
        <Container className='text-align-center'>
          ...
          <Navbar.Collapse id='navbarScroll'>
            <Nav className='me-auto my-2 my-lg-0' style={{ maxHeight: '100px' }}>
              <div  defaultActiveKey="/home" className='d-flex tses1 '>
                <NavLink to='/home' className='menu black poppins'>
                  НҮҮР
                </NavLink>
                <NavLink to='/main' className='menu poppins black'>
                  ХООЛНЫ ЦЭС
                </NavLink>
              ...
              <div className='collapse1'>
                <div className='division'>
                  <div className='d-flex justify-content-between align-items-center   flex-row'>
                    ...
                    <Nav.Link to='/home' className='tses align-items-center'>
                      Хоолны цэс
                    </Nav.Link>
                    <svg width='35' height='35' viewBox='0 0 35 35' fill='none' xmlns='http://www.w3.org/2000/svg'>
                      <path
                ...
                <div className='division'>
                  <div className='d-flex justify-content-between flex-row align-items-center'>
                    ...
                    <Nav.Link to='./' className='tses align-items-center'>
