              ...
              <Card.Body className="cardBody">
                ...
                <div className="prices mx-2 row ">
                    ...
                    <NumberFormat
                      value={
                        (foodsDetail.final_price =
                          foodsDetail.price - (foodsDetail.price * foodsDetail.discount_percentage) / 100)
                      }
                      displayType={'text'}
                  ...
                  <Card.Text className="finalPrice col-6">
                    <strike style={foodsDetail.discount_percentage == 0 ? { display: 'none' } : { display: 'block' }}>
                      <NumberFormat
                        value={foodsDetail.price}
                        displayType={'text'}
                        thousandSeparator={true}
                        suffix={'₮'}
                      />
                ...
                <Card.Text
                  ...
                  style={foodsDetail.discount_percentage == 0 ? { display: 'none' } : { display: 'block' }}
                >
                  {foodsDetail.discount_percentage}%
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
