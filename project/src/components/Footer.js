    ...
    <footer>
      <div className="container pb-4 pt-4">
        <div className="row mt-md-4 mt-5">
          <h4 className="col-12 col-xs-12 col-md-4 col-lg-3">
            <img src={logo} /> Food Delivery
          </h4>
        ...
        <div className="row footer_bottom_section py-sm-2 mt-5">
          <div className="col-md-4 social text-center text-md-start text-center">
            ...
            <p className="px-md-4">
              <a className="footer_icon pl-4" href="https://www.facebook.com">
                <i className="fab fa-facebook"></i>
              </a>
              <a className="footer_icon mx-3" href="https://www.instagram.com">
                <i className="fab fa-instagram"></i>
              </a>
              <a className="footer_icon" href="https://www.twitter.com">
